...
@section('content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800 text-center">افلام / مسلسلات اجنبية</h1>
    ...
    <!-- Tv Show section -->
    <h1 class="h3 mb-4 text-gray-800 text-center">افلام / مسلسلات تركية</h1>
    <div class="row">
        <!-- Movies Card -->
        <div class="col-xl-6 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
    ...
    <h1 class="h3 mb-4 text-gray-800 text-center">افلام/حلقات انمي</h1>
    <div class="row">
        <!-- Movies Card -->
        <div class="col-xl-6 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
