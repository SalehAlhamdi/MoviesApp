    ...
    <main>
        ...
        <section class="banner">
            <div class="banner-card">
                ...
                <img src="{{asset("movie/assets/images/John-Wick-3.jpg")}}" class="banner-img" alt="">
        ...
        <section class="movies">
            ...
            <div class="movies-grid">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/red-notice.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/spider-men.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/matrix.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/eternals.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/dune.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/1917.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/shang-chi.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/casino-royale.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/dark-knight.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/panther.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/venom.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/LOTR.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/saving-private-ryan.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/interstaller.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/gladiator.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/endgame.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/ww84.jpg")}}" alt="" class="card-img">
                ...
                <div class="movie-card">
                    ...
                    <div class="card-head">
                        <img src="{{asset("movie/assets/images/movies/captain-marvel.jpg")}}" alt="" class="card-img">
